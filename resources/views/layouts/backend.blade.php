...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend/assets') }}/css/components-v2.css" />
    <title>Mr Code Happy</title>
</head>
<body class="h-full">
<div>
    <div
    ...
    >
        ...
        >
            ...
            <div
                class="flex-shrink-0 flex items-center h-16 flex-shrink-0 px-4 bg-white"
            >
                <img
                    class="h-8 w-auto"
                        ...
                        <div>
                            ...
                            >
                                ...
                                <img
                                    ...
                                    src="https://khoahoclaptrinh.top/frontend/assets/images/x-icon.png"
                                    alt=""
                                />
                            </button>
                        </div>
...
@include('backend.shared.javascript')
